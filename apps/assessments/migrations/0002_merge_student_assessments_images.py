# State-only migration: StudentAssessment/AssessmentImage tables already exist
# (created previously under the now-removed student_assessments/assessment_images apps).
# This just re-registers their model state under the "assessments" app label.
